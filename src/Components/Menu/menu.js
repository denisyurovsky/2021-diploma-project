...
function Menu () {
     ...
     const cards = useSelector(state => state.menuReducer.menu)
     ...
     let totalItems = Selectedcards.length;
     
        return (   
            <div className="menu-wrapper">
                <div className="menu__header">
                    <span className="menu__title">НАША ПРОДУКЦИЯ</span>
                    <div className="menu__shopping-cart">
                        <span className='menu__total-items'>Количество товара: {totalItems}</span>
                        <br/>
                        <span className='menu__total-price'>на сумму {totalPrice} ₽</span>
                    </div>
                    <Link to='/cart'>
                    <button className='menu__total-cart-button'>
